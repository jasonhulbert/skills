...
Write a handoff prompt summarizing the current conversation so a fresh agent can continue the work.

Save the prompt to the temporary directory of the user's OS - not the current workspace.
